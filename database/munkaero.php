...
<html>
    ...
    <body>
    <?php require_once 'munkaeroprocess.php'; ?>
        <div class="container">
        <?php
        $mysqli = new mysqli('localhost', 'webbead2', 'webbead2', 'webbead2') or die(mysqli_error($mysqli));
        $result=$mysqli->query("SELECT * FROM munkaero") or die($mysqli->error);
        //pre_r($result);
        ?>
